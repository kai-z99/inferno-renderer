...
void GLTFMetallic_Roughness::build_pipelines(VulkanEngine* engine)
{
	...
	layoutBuilder.add_binding(4, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER); //emissive
	...
	layoutBuilder.add_binding(10, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER); //iridescence (R)
	layoutBuilder.add_binding(11, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER); //iridescence thickness (G)
	...
	DescriptorAllocatorGrowable& descriptorAllocator)
{
	...
	writer.write_image(4, resources.emissiveImage.imageView, resources.emissiveSampler, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
	...
	writer.write_image(10, resources.iridescenceImage.imageView, resources.iridescenceSampler, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
	writer.write_image(11, resources.iridescenceThicknessImage.imageView, resources.iridescenceThicknessSampler, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
